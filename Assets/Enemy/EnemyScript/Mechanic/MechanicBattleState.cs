...
public class MechanicBattleState : EnemyState
{
    private Transform player;
    private Enemy_Mechanic enemy;
    private int moveDir;
    public MechanicBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Mechanic enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = enemy;
    }
